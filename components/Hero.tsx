    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6">
          <span className="block text-slate-100">Your Website, SaaS, or App</span>
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-400 mb-10 leading-relaxed">
          I’m Jay, a YouTuber and full-stack engineer with 13+ years of enterprise experience.
          I help creators and founders launch real products with AI, automations, and custom software.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          ...
          >
            Build My App <ArrowRight size={20} />
          </a>
          <a 
            href="#portfolio" 
        ...
        <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto border-t border-slate-800/50 pt-8 opacity-60">
          ...
          <div className="flex flex-col items-center gap-2 text-slate-500">
            <Globe size={24} />
            <span className="text-xs font-medium uppercase tracking-wider">Websites</span>
          </div>
          <div className="flex flex-col items-center gap-2 text-slate-500">
            <Cpu size={24} />
            <span className="text-xs font-medium uppercase tracking-wider">SaaS & AI</span>
          </div>
        </div>
      </div>
    </section>
